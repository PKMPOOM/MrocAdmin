export type CountryCodeTypes = {
  name: string;
  code: string;
  phone: number;
};

export const countriesTelCodelist: CountryCodeTypes[] = [
  ...
  { name: "Democratic People's Republic of Korea", code: "KP", phone: 850 },
  { name: "Korea", code: "KR", phone: 82 },
