...
function CardSection({ SectionData }: Props) {
  ...
  return (
    <div className="tw-px-4 tw-my-2 tw-w-full  ">
      <div className="tw-flex tw-flex-col lg:tw-flex-initial 2xl:tw-max-w-6xl tw-mx-auto tw-gap-2 tw-justify-stretch">
        ...
        <div className="tw-flex tw-justify-center tw-flex-col tw-w-full lg:tw-flex-row lg:tw-flex-initial 2xl:tw-max-w-6xl tw-mx-auto">
